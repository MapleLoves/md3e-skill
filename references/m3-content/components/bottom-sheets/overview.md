...
> 来源: https://m3.material.io/components/bottom-sheets/overview
...
## Bottom sheets
  ...
  * Use bottom sheets in  compact Window widths smaller than 600dp, such as a phone in portrait orientation.  [More on compact window size class](</m3/pages/breakpoints/compact>) and  medium window sizes Window widths from 600dp to 839dp, such as a tablet or foldable in portrait orientation.  [More on medium window size class](</m3/pages/breakpoints/medium>)
...
[ android  Android Views (MDC-Android) ](<https://github.com/material-components/material-components-android/blob/master/docs/components/BottomSheet.md>)| Available
[ android  Jetpack Compose ](<https://developer.android.com/develop/ui/compose/components/bottom-sheets>)| Available
