...
![A selected list item with a colored background, and a check as the leading icon.](../../_assets/mif14iza-01-b2a64cb06827ece903c2.png)
...
![A list with the second item visually altered while hovered over, with a cursor and darker fill.](../../_assets/mif1lpwx-03-40e667aec6e9e56961dd.png)

Cursor: Hover

![Selected list item with cursor, colored fill, and checked box.](../../_assets/mif1n85t-04-8fd346b1e46a70bd26ed.png)
...
![A list item has a “more” button selected to reveal additional actions.](../../_assets/mshqfb4p-07-key04-4d22f8c1d56a2fa550b6.png)

List items can reveal more actions from swiping or using an accessible secondary action such as a double tap
...
After an element is focused A focused state communicates when a user has highlighted an element, using an input method such as a keyboard or voice. [More on focused state](/m3/pages/interaction-states/applying-states#bc6d6853-48ef-490e-8076-448e89e69f0f) , a person should be able to navigate within the list using arrow keys.

![The first list item is automatically focused.](../../_assets/mif1yik5-08-26c9eab5ec4a706e07d1.png)

**Tab** key focuses on the first item or the selected item

![A second list item focused using an arrow key.](../../_assets/mif1z0du-09-c1b1798ae1f2818c7423.png)
...
![List item with focus indicator and filled checkbox, selected using the Space or Enter key.](../../_assets/mif21ldt-10-cff0cd3f6317f33dd61f.png)
...
![The first element in a multi-action list is focused automatically.](../../_assets/mi8um9bl-11-VQA-59309f122e0a520ee1bb.png)

**Tab** brings the focus to the first action

![The list action, a bookmark, is focused using the Down or Right arrow.](../../_assets/mi8uomf0-12-VQA-91f802c748e8d4380f83.png)

**Down** and **Right** arrow keys move focus to the next action of the list item, or to the first action in the next item

![A trailing bookmark icon is focused in the second list item.](../../_assets/mi8uwmgu-13-VQA-8a128623ee19aee8b5d8.png)

**Up** and **Left** arrow keys move focus to the previous action of the list item

![Label text and supporting text of the second list item is in focus using the Up or Left arrow.](../../_assets/mi8v0dqs-14-VQA-33015bc5016770dd5b91.png)
...
![The Space or Enter key activates an overflow menu on a list item.](../../_assets/mi8v14y1-15-VQA-401386007c1a7cf4ebe3.png)
...
![List item selected to show label of “Bread, sourdough or wheat”.](../../_assets/mif3ecf9-16-8477b1783f68aa5cf388.png)
...
![A list container is selected, showing a label of “Select either bread, pita, or rice” and role of “List box.”](../../_assets/mi8wfvkj-17-5f704c9644e355f64612.png)
...
![A selected list item shows a label of “Bread, sourdough, or wheat” and role of “Checkbox.”](../../_assets/mi8wgxsf-18-444bf42ea1071c4b4e41.png)
...
![Checkbox of a selected list item shows label of “Bread, sourdough or wheat” and role of “Checkbox.”](../../_assets/mif3mprn-19-fd585658c5337b376809.png)
