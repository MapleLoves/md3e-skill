...
> 来源: https://m3.material.io/components/button-groups/specs
...
Connected button group| Available as  segmented button Segmented buttons help people select options, switch views, or sort elements. Note: They're deprecated in the expressive update. Use a nav rail instead.  [More on segmented buttons](</m3/pages/segmented-buttons/overview>)
| Available
...
Selection| Single-select, multi-select, selection-required| Available as  segmented button Segmented buttons help people select options, switch views, or sort elements. Note: They're deprecated in the expressive update. Use a nav rail instead.  [More on segmented buttons](</m3/pages/segmented-buttons/overview>)
| Available
