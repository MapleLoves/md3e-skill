...
> 来源: https://m3.material.io/styles/color/static/custom-brand
...
[Baseline](<styles/color/static/baseline>)[Custom brand](<styles/color/static/custom-brand>)
...
**Then, update any remaining non-brand color styles**
  ...
  5. Select the brand color role that most closely matches that color's use case (see [Color roles](</m3/pages/color-roles>) for more information on what color to use where) and select **Use style** to apply it to the selected objects
