...
> 来源: https://m3.material.io/styles/color/dynamic/user-generated-source
...
**Then, update any remaining non-color-role-based colors**
  ...
  5. Select the color-role-based color that most closely matches that color's use case (see [Color roles](</m3/pages/color-roles>) for more information on what color to use where) and select **Use style** to apply it to the selected objects
