...
> 来源: https://m3.material.io/styles/color/advanced/define-new-colors
...
[Overview](<styles/color/advanced/overview>)[Apply colors](<styles/color/advanced/apply-colors>)[Define new colors](<styles/color/advanced/define-new-colors>)[Adjust existing colors](<styles/color/advanced/adjust-existing-colors>)
